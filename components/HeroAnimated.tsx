...
export function HeroAnimated() {
  ...
  if (!mounted) {
    return (
      <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
        <div className="container relative z-10 mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            <h1 className="mb-4 text-5xl font-bold tracking-tight text-slate-900 dark:text-slate-100 sm:text-6xl md:text-7xl">
              Hi, I&apos;m <span className="bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-500 bg-clip-text text-transparent">Kairui Cheng</span>
            </h1>
          </div>
        </div>
      </section>
    ...
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -inset-[10px] opacity-50">
          <div className="absolute left-1/4 top-1/4 h-96 w-96 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500 opacity-20 blur-3xl" />
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="mb-8 flex h-12 items-center text-2xl font-medium text-slate-600 dark:text-slate-300 sm:text-3xl"
          >
            <motion.span
              key={taglineIndex}
              initial={{ opacity: 0, y: 20 }}
          ...
          >
            <Link
              href="/projects"
              className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-indigo-500 to-violet-500 px-8 py-3 font-medium text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl"
            >
